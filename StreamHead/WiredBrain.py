...
class LogHead:
    def __init__(self, root):
        ...
        self.text_area = tk.Text(self.root, bg="black", fg="magenta", insertbackground="white", font=("Courier", font_size))
        self.text_area.pack(expand=1, fill='both')

        self.exit_button = tk.Button(self.root, text="^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>Exit^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>^*}>", command=self.exit_fullscreen, bg="red", fg="white")
        self.exit_button.pack(anchor="ne", padx=4, pady=2)
    ...
    def update_text_area(self):
        ...
        new_line = ''.join(random.choices("680164", k=char_width))
